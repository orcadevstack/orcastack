...
export default function SettingsDropdown({ items, onNavigate }: Props) {
  return <HeaderDropdownContent items={items} onNavigate={(_, path) => onNavigate(path)} section="settings" />;
}